...
class CMUser extends CObject implements IHasSQL, IModule, ArrayAccess {
	...
	//-------------------------------------------------------------------------------------
	// Constructor
	public function __construct($drygia=null) {
		parent::__construct($drygia);
   ...
   */
	public function Manage($action=null) {
		switch($action) {
			...
			default: throw new Exception('Unsupported action for this module.');
				break;
    }
  }
	...
	*/
	public function CreatePassword($plain, $algorithm=null) {
		$password = array(
			'algorithm'=>($algorithm ? $algoritm : CDrygia::Instance()->config['hashing_algorithm']),
			'salt'=>null
		);
